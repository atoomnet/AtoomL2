...
public class RSSFeedAdaptor extends BaseAdapter {
	...
	private final List<RSSFeedEntry> m_entries = new LinkedList<RSSFeedEntry>();

	public RSSFeedAdaptor(Context context) {
		m_context = context;
	...
	public void addEntry(RSSFeedEntry entry) {
		m_entries.add(entry);
	}
	...
	public View getView(int i, View convertView, ViewGroup parent) {
		...
		RSSFeedEntry entry = m_entries.get(i);
