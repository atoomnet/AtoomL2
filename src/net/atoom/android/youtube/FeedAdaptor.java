...
//		dateView = (TextView) vlv.getChildAt(1);
		dateView = (TextView) ((RelativeLayout) vlv.getChildAt(1)).getChildAt(0);

//		} else {
//
//			LayoutInflater.from(m_context).inflate(R.layout.l2_feedentry, parent);
//			((L2Activity) m_context).getLayoutInflater().inflate((R.layout.l2_feedentry));
